        ...
        <div className={`home_page_container flex flex-col items-center justify-center text-white px-6 h-[100%] ${darkMode ? "bg-gray-900" : "bg-gray-100"}`}>
            ...
            <div className="flex w-full max-w-7xl gap-8 flex-col md:flex-row items-center justify-center">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/3 space-y-4 pl-1 pt-1">
                    <motion.img
                        src="../../public/profile.jpeg" // Replace with your actual photo
                        alt="Profile"
                    ...
                    <div className="flex space-x-3">
                        <button className="bg-blue-600 px-4 py-2 rounded-md hover:bg-blue-500 transition cursor-pointer">
                            Preview Projects
                        </button>
                ...
                <div className={`relative w-full md:w-1/2 rounded-lg shadow-lg p-4 border h-80 font-mono ${darkMode ? "bg-gray-800 border-gray-700" : "bg-gray-200 border-gray-400"}`}>
                    ...
                    <div className="flex">
                        <pre className="text-gray-200 whitespace-pre leading-relaxed w-full">
                            ...
                            <div className={`line flex pl-18 ${darkMode ? "text-white" : "text-black"}`}>
                                <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>Node.js<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>Python<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>C++<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>SQL<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span><span className={`flex items-center justify-center ${darkMode ? "text-gray-500" : "text-gray-400"}`}>Angular.js <i class="fa-solid fa-arrow-down fa-bounce text-yellow-400"></i></span><span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, 
                            </div>
                            <div className={`line flex pl-18 ${darkMode ? "text-white" : "text-black"}`}>
                                <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>TailwindCSS<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span><span className={`flex items-center justify-center ${darkMode ? "text-gray-500" : "text-gray-400"}`}>Node.js <i class="fa-solid fa-arrow-down fa-bounce text-yellow-400"></i></span><span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>Bootstrap<span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, <span className={darkMode ? "text-green-400" : "text-green-500"}>"</span><span className={`flex items-center justify-center ${darkMode ? "text-gray-500" : "text-gray-400"}`}>MongoDB <i class="fa-solid fa-arrow-down fa-bounce text-yellow-400"></i></span><span className={darkMode ? "text-green-400" : "text-green-500"}>"</span>, 
                            </div>
                            <div className={`line flex pl-12 ${darkMode ? "text-white" : "text-black"}`}>
                                <span className={darkMode ? "text-green-400" : "text-green-500"}>]</span>
                            </div>
